...
**NOTE:** If you want to use the default navigation styles, you will also need to include `owl.template.default.css`.
...
```html
<div class="owl-carousel owl-template">
...
```
**NOTE:** The `owl-template` class is optional, but without it, you will need to style navigation features on your own.
